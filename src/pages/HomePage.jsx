...
const HomePage = () => {
  return (
    <div className="flex flex-col justify-center items-center max-w-3xl h-screen mx-auto p-4">
      <div className="flex justify-center items-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-600 to-indigo-500 rounded-[40px] h-full max-h-[1000px] w-full">
